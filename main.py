...
#change hf --> groq use groq API
from GROQ import generate_response
#from groq import generate_response

def bias_mitigation_activity():
    print("\n=== BIAS MITIGATION ACTIVITY ===\N")
    ...
    modified_prompt = input(
        "Modified the prompt to make it more neutral (e.g., 'Describe the qualitis of a doctor'):"
...
def token_limit_activity():
    ...
    if short_prompt:
        ...
        print(f"\nResponse to Condensed Prompt: {short_prompt}")
    else:
